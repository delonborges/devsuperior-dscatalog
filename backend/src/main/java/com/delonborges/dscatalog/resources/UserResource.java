...
public class UserResource {
    ...
    @PostMapping
    public ResponseEntity<UserDTO> insert(@Valid @RequestBody InsertUserDTO dtoItem) {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<UserDTO> update(@PathVariable Long id,@Valid @RequestBody UserDTO dtoItem) {
