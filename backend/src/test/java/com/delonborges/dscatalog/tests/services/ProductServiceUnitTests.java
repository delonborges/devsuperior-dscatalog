...
@ExtendWith(SpringExtension.class) public class ProductServiceUnitTests {
    ...
    @Test public void findAllPagedShouldReturnPage() {
        Page<ProductDTO> result = productService.findAllPaged(0L, "", pageable);

        assertNotNull(result);
    }

    @Test public void findByIdShouldReturnDTOWhenIdExists() {
    ...
    @Test public void findByIdShouldThrowExceptionWhenIdDoesNotExist() {
    ...
    @Test public void updateShouldReturnDTOWhenIdExists() {
    ...
    @Test public void updateShouldThrowExceptionWhenIdDoesNotExist() {
    ...
    @Test public void deleteShouldThrowExceptionWhenIdIsDependent() {
